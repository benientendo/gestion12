#!/usr/bin/env python
"""
Script pour remplacer le fichier models.py corrompu
"""
import os

# Contenu propre du fichier models.py
CLEAN_MODELS_CONTENT = '''from django.db import models
...
def fix_models():
    """Remplacer le fichier models.py corrompu"""
    
    try:
        # Écrire le contenu propre
        with open('inventory/models.py', 'w', encoding='utf-8') as f:
            f.write(CLEAN_MODELS_CONTENT)
        
        print("✅ Fichier models.py remplacé avec succès!")
        return True
